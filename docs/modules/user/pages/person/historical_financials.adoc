...
Clicking the view allocation button (#1) expands the payment details dialog (shown below) showing obligation type and case number associated with the fine/fee.
